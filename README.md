...
**Lớp:** 3A · **Phòng:** E403 · **Cụm:** C6 · **Track:** D - Học tập thích ứng & tương tác

| Họ và Tên | Mã Học Viên | Vai trò chính & Phần việc đảm nhiệm trong dự án |
|---|---|---|
| **Nguyễn Trọng Phúc** | 2A202602552 | **Project Lead:** Lên ý tưởng sản phẩm, phân tích đề/track, xây dựng golden set 20 ca, chuẩn hóa rubric đánh giá & lập trình Frontend. |
| **Nguyễn Quốc Đạt** | 2A202602369 | Khảo sát người dùng, tìm thông tin, mining bằng chứng từ data pack & phân tích insight. |
| **Nguyễn Trần Nhựt Nam** | 2A202602981 | Phát triển phần AI, tối ưu hóa chất lượng, tốc độ và chi phí (cost) phản hồi từ AI. |
| **Nguyễn Văn Huy** | 2A202602428 | Thiết kế UI/UX điểm dừng tương tác, hỗ trợ frontend & quay video demo. |
